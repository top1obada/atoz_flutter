...
class PVCustomerPreviousRequestsStores extends ChangeNotifier {
  ...
  Future<void> getCustomerPreviousRequestsStores(
    ...
    final result = await StoreConnection.getCustomerPreviousRequestsStores(
